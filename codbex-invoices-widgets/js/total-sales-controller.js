const dashboard = angular.module('total-sales', ['ideUI', 'ideView']);

dashboard.controller('totalSalesController', ['$scope', '$document', '$http', 'messageHub', function ($scope, $document, $http, messageHub) {
    $scope.state = {
        isBusy: true,
        error: false,
        busyText: "Loading...",
